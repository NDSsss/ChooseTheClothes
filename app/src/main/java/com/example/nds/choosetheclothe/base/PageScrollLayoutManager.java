...
public class PageScrollLayoutManager extends RecyclerView.LayoutManager {
    ...
    private PageScrollItemTransformer itemTransformer;

    public PageScrollLayoutManager(
            @NonNull Context c,
    ...
    public void setItemTransformer(PageScrollItemTransformer itemTransformer) {
